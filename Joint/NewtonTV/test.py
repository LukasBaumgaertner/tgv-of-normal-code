...
mesh = utils.utils.ReadMeshH5("../joint.h5") 
mesh.init()

AL = AugmentedLagrangian(mesh, alphas=[0.00008,0.003], rhos=[0.001,0.00001,0.00001], tau = 1e-12)
...
ADMM(AL,Newton,cb = cb, max_outer_iter = 300 , max_inner_iter=2, verbose=True, with_aux=False)
