...
mesh = utils.utils.ReadMeshH5("../half-spheres.h5") 
mesh.init()

AL = AugmentedLagrangian(mesh, alphas=[0.00003,0.0035], rhos=[0.001,0.000001,0.000001], tau = 1e-12)
...
ADMM(AL, Newton,cb = cb, max_outer_iter = 300 , max_inner_iter=3, verbose=True)
